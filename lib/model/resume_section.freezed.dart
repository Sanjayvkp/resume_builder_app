...
ResumeSection _$ResumeSectionFromJson(Map<String, dynamic> json) {
  return _ResumeSection.fromJson(json);
}
...
class _$ResumeSectionImpl implements _ResumeSection {
  ...
  factory _$ResumeSectionImpl.fromJson(Map<String, dynamic> json) =>
      _$$ResumeSectionImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$ResumeSectionImplToJson(
      this,
    );
  }
}
...
abstract class _ResumeSection implements ResumeSection {
  ...
  factory _ResumeSection.fromJson(Map<String, dynamic> json) =
      _$ResumeSectionImpl.fromJson;
